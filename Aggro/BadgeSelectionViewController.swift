//
//  BadgeSelectionViewController.swift
//  Aggro
//
...
class BadgeSelectionViewController: UIViewController, UITextFieldDelegate, UITableViewDataSource, UITableViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        NSNotificationCenter.defaultCenter().addObserver(self, selector: "badgeDataError", name: "badgeDataError", object: nil)
    ...
    func badgeDataError() {
        let title: String =  "badgeDataError"
        let alertController = UIAlertController(title: title, message: "Badge Data Error",
            preferredStyle: .Alert)
